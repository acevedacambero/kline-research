...
export type WalkForwardResult = { version: string; averageAuc?: number | null; averageAccuracy?: number | null; folds: Array<{ trainUntil: string; status: string; trainCount: number; testCount: number; auc?: number | null; accuracy?: number | null }>; warnings: string[] }
