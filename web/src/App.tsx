...
export function App() {
  ...
  async function runScan() {
    setBusy(true)
    try { const result = await api.scanP3(scanMinScore, scanExchange || undefined, scanAsOfDate); setScan(result); setMessage(`P6 扫描：${result.rows.length} 个高分样本`) }
