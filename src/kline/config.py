...
class Settings(BaseSettings):
    ...
    artifact_retention_auto_enabled: bool = False
...
VERSIONS = {
    ...
    "multiFeatureModelDefinitionVersion": "p7-multifeature-logistic-v2-inference",
    ...
    "portfolioValidationVersion": "p8-top-score-portfolio-v5-turnover",
